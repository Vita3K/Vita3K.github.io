...
texts.push([
	...
	"O Vita3K", // 9
	"Vita3K to pierwszy na świecie eksperymentalny emulator PlayStation Vita z otwartym kodem źródłowym dla Windows, Linux i macOS.", // 10
...
texts.push([
	...
	"Узнать больше", // 8
	"О Vita3K", // 9
	"Vita3K - это первый в мире рабочий, экспериментальный эмулятор PlayStation Vita с открытым кодом для Windows, Linux и macOS.", // 10
	...
	"Эмулятор может запускать некоторые <b>коммерческие игры!</b><br>Проверьте их <a href=\"compatibility.html?lang=ru\">список совместимости</a>.<br><br>Несколько homebrew игр также поддерживаются. Cверьтесь со <a href=\"compatibility-homebrew.html?lang=ru\">homebrew списком совместимости</a> для более подробной информации", // 19
	"Самодельный порт игры", // 20
	"Торговые марки PlayStation и PS Vita принадлежат Sony Interactive Entertainment Inc.", // 21
	"Эмулятор не связан с компанией Sony, не поддерживается ею и не получен из конфиденциальных материалов, принадлежащих Sony.", // 22
	"Логотип от", // 23
	...
	"Отчитывайтесь о неполадках и предлагайте код в нашей <a href=\"https://github.com/Vita3K/Vita3K\">репозитории на GitHub</a>.", // 33
	"Что нового", // 34
...
texts.push([
	...
	"了解更多", // 8
	"关于Vita3K", // 9
	"Vita3K是世界上首个在Windows、Linux和macOS上的实验性开源PlayStation Vita模拟器。", // 10
...
texts.push([
	...
	"くわしく", // 8
	"Vita3Kとは", // 9
	"Vita3Kは、世界初の機能的かつ実験的なオープンソースのWindows、LinuxおよびmacOS用PlayStation®Vitaエミュレータです。", // 10
