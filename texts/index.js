...
// Russian (Translation provided by Dum4G)
texts.push([
	"Что это?", // 0
	"Скачать", // 1
	"Сообщество", // 2
	...
	"Содействие", // 5
	"Пожертвования", // 6
	"Первый рабочий эмулятор PlayStation Vita.", // 7
	"Узнайте больше", // 8
	"О Vita3K", // 9
	"Vita3K - это первый в мире, рабочий экспериментальный эмулятор PlayStation Vita с открытым исходным кодом для Windows, Linux и macOS.", // 10
	...
	"Эмулятор запускает некоторые <b>коммерческие игры!</b><br>Проверьте их в <a href=\"compatibility.html?lang=ru\">списке совместимости<a>.<br><br>Также поддерживается ряд самодельных игр. Cверьтесь со <a href=\"compatibility-homebrew.html?lang=ru\">списком совместимости самодельных игр</a> чтобы узнать подробности.", // 19
