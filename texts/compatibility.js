...
texts.push([
	...
	"Теги", // 14
	"Homebrew приоржение, которые приводят к вылету эмулятора.", // 15
	"Homebrew приложение, которые работают с багами или глюками.", // 16
	"Homebrew приложение, которые запускаются с крайне низкой частотой кадров.", // 17
	"Homebrew приложение, которые идеально играемы.", // 18
	"Название", // 19
	"Состояние", // 20
	...
	"Игры, которые вообще не запускаются, не отображая начальный черный экран со счетчиком FPS.", // 27
	...
	"Игры, которые работают правильно, но не могут войти в игру(доходят только до меню).", // 30
	"Игры, которые заходят в игру, но имеют серьезные проблемы, которые мешают дальше.", // 31
	"Игры, которые заходят далеко в игре, но имеют глюки, которые делают игру непригодной для игры или имеют неиграбельную производительность.", // 32
