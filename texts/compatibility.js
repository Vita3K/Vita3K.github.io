...
texts.push([
	...
	"Все", // 11
	"На главную", // 12
	"Совместимость самодельных игр", // 13
	"Теги", // 14
	"Самоделки, которые приводят к вылету эмулятора.", // 15
	"Самоделки, прохождение которых затруднено неполадками или глитчами.", // 16
	"Самоделки, которые запускаются с крайне низкой частотой кадров.", // 17
	"Самоделки, которые идеально проходимы.", // 18
	"Название", // 19
	"Состояние", // 20
	...
	"Игры, которые вообще не загружаются и не отображают начальный черный экран со счетчиком кадров.", // 27
	"Игры, которые загружаются, но отображают только черный экран со счетчиком кадров.", // 28
	"Игры, способные вывести изображение на экран, но не доходящие до меню.", // 29
