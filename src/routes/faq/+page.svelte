...
<section class="bg-dark text-white pb-5">
    <div class="container">
        ...
        <div class="my-5">
            <h6>
                First you have to install them. When you do, you only need to
                run the emulator and it will display a <em>Game Select</em> Screen.
            </h6>
        </div>
        ...
        <div class="my-5">
            <h6>
                ...
                square in the middle of your screen)
            </h6>
        </div>
